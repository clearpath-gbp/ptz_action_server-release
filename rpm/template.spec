...
Name:           ros-jazzy-ptz-action-server-msgs
Version:        2.0.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS ptz_action_server_msgs package
...
%changelog
* Fri Nov 01 2024 Chris Iverach-Brereton <civerachb@clearpathrobotics.com> - 2.0.3-1
